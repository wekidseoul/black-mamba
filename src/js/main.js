...
upBtn.addEventListener("touchstart", keyEvent);
downBtn.addEventListener("touchstart", keyEvent);
leftBtn.addEventListener("touchstart", keyEvent);
rightBtn.addEventListener("touchstart", keyEvent);